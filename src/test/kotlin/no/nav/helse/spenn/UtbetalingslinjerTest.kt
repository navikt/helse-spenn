...
internal class UtbetalingslinjerTest {
    ...
    fun `Sjekksum er ulik for to oppdrag når mottaker er forskjellig`() {
        val oppdrag1 =
            Utbetalingslinjer.RefusjonTilArbeidsgiver(PERSON, ORGNR, UTBETALINGSREF, "NY", "", LocalDate.MAX).apply {
                linje(
                    Utbetalingslinjer.Utbetalingslinje(
                        1,
                        "NY",
        ...
        val oppdrag2 =
            Utbetalingslinjer.RefusjonTilArbeidsgiver(PERSON, "Et annet orgnr", UTBETALINGSREF, "NY", "", LocalDate.MAX)
                .apply {
                    linje(
                        Utbetalingslinjer.Utbetalingslinje(
                            1,
    ...
    fun `Sjekksum er ulik for to oppdrag når person er forskjellig`() {
        ...
        val oppdrag2 =
            Utbetalingslinjer.RefusjonTilArbeidsgiver("en annen person", ORGNR, UTBETALINGSREF, "NY", "", LocalDate.MAX)
                .apply {
                    linje(
                        Utbetalingslinjer.Utbetalingslinje(
                            1,
    ...
    fun `Sjekksum er ulik for person-oppdrag og arbeidsgiveroppdrag`() {
        ...
        val oppdrag2 = Utbetalingslinjer.UtbetalingTilBruker(
            PERSON,
            PERSON,
            "ET ANNET ORGNR",
            UTBETALINGSREF,
    ...
    fun `Sjekksum er ulik for to person-oppdrag når mottaker er forskjellig`() {
        val oppdrag1 =
            Utbetalingslinjer.UtbetalingTilBruker(PERSON, PERSON, ORGNR, UTBETALINGSREF, "NY", "", LocalDate.MAX)
                .apply {
                    linje(
                        Utbetalingslinjer.Utbetalingslinje(
                            1,
