...
public class Oppdragstate extends TableImpl<OppdragstateRecord> {
    ...
    private static final long serialVersionUID = -1436799043;
     ...
     */
    public final TableField<OppdragstateRecord, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('oppdragstate_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>public.oppdragstate.soknad_id</code>.
     */
    public final TableField<OppdragstateRecord, UUID> SOKNAD_ID = createField("soknad_id", org.jooq.impl.SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>public.oppdragstate.created</code>.
     */
    public final TableField<OppdragstateRecord, Timestamp> CREATED = createField("created", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("now()", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>public.oppdragstate.modified</code>.
     */
    public final TableField<OppdragstateRecord, Timestamp> MODIFIED = createField("modified", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("now()", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>public.oppdragstate.utbetalingsoppdrag</code>.
     */
    public final TableField<OppdragstateRecord, String> UTBETALINGSOPPDRAG = createField("utbetalingsoppdrag", org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.oppdragstate.status</code>.
     */
    public final TableField<OppdragstateRecord, String> STATUS = createField("status", org.jooq.impl.SQLDataType.VARCHAR(16).nullable(false), this, "");

    /**
     * The column <code>public.oppdragstate.oppdragresponse</code>.
     */
    public final TableField<OppdragstateRecord, String> OPPDRAGRESPONSE = createField("oppdragresponse", org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>public.oppdragstate.simuleringresult</code>.
     */
    public final TableField<OppdragstateRecord, String> SIMULERINGRESULT = createField("simuleringresult", org.jooq.impl.SQLDataType.CLOB, this, "");
