...
public class OppdragstateRecord extends UpdatableRecordImpl<OppdragstateRecord> implements Record9<Long, UUID, Timestamp, Timestamp, String, String, String, String, String> {
    ...
    private static final long serialVersionUID = 554249037;
     ...
     */
    public OppdragstateRecord(Long id, UUID sakskompleksId, Timestamp created, Timestamp modified, String utbetalingsoppdrag, String status, String oppdragresponse, String simuleringresult, String feilbeskrivelse) {
        super(Oppdragstate.OPPDRAGSTATE);
