...
internal class OppdragBuilderTest {
    ...
    fun `bygger oppdrag til arbeidsgiver`() {
        val oppdrag =
            oppdragRefusjon(ENDRINGSKODE_ENDRET) {
                linje(
    ...
    fun `bygger oppdrag til bruker`() {
        val oppdrag =
            oppdragBruker(ENDRINGSKODE_UENDRET) {
                linje(
                    Utbetalingslinjer.Utbetalingslinje(
                        1,
                        ENDRINGSKODE_NY,
    ...
    fun `brukerlinje opphører`() {
        val oppdrag =
            oppdragBruker(ENDRINGSKODE_ENDRET) {
                linje(
                    Utbetalingslinjer.Utbetalingslinje(
                        1,
                        ENDRINGSKODE_ENDRET,
    ...
    private fun assertArbeidsgiverlinje(
        ...
        assertEquals(
            MAKSDATO,
            oppdrag.oppdrag110.oppdragsLinje150[index]
                .refusjonsinfo156
                ?.maksDato,
        )
        assertEquals(
