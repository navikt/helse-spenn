    ...
    private fun onMessage(xmlMessage: String) {
        rapidsConnection.publish(
            JsonMessage
                ...
                .also { sikkerLogg.info("sender oppdrag_kvittering:\n$it") },
        )
        ...
        rapidsConnection.publish(
            ...
            JsonMessage
                ...
                .also { sikkerLogg.info("sender transaksjon status=$it") },
        )
    }
}
