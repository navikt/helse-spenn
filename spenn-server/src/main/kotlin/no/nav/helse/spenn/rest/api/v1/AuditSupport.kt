...
class AuditSupport {
    companion object {
        ...
        const val identClaimForAuditLog = "preferred_username"
    }
    ...
    private fun navIdent(auth: AuthenticationContext): String {
        ...
        return ident ?: throw IllegalStateException("Using no token or token without required claim in auditlogging")
    }
