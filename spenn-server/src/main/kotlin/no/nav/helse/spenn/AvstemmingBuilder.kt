...
import no.nav.helse.spenn.oppdrag.ØkonomiKodekomponent
    ...
    private fun avstemmingsdata(aksjonstype: AksjonType) =
        Avstemmingsdata().apply {
            aksjon = Aksjonsdata().apply {
                ...
                avleverendeKomponentKode = ØkonomiKodekomponent.SYKEPENGEBEHANDLING.kodekomponent
                mottakendeKomponentKode = ØkonomiKodekomponent.OPPDRAGSSYSTEMET.kodekomponent
                underkomponentKode = FagOmraadekode.SYKEPENGER_REFUSJON.kode
