...
internal class Simuleringer(
    ...
    private fun håndter(
        ...
        try {
                ...
                SimuleringRequest(
                    ...
                    oppdrag =
                        SimuleringRequest.Oppdrag(
                            fagområde =
                                when (val fagområde = packet["Simulering.fagområde"].asText()) {
                            ...
                            linjer =
                                packet["Simulering.linjer"].map { linje ->
                                    SimuleringRequest.Oppdrag.Oppdragslinje(
                                        ...
                                        satstype =
                                            when (val type = linje.path("satstype").asText()) {
                                        ...
                                        klassekode =
                                            when (val kode = linje.path("klassekode").asText()) {
            ...
            when (val result = simulerMedRetry(simulerRequest)) {
                ...
                is Result.Ok ->
                    when (val simuleringresultat = result.value) {
    ...
    private class SimuleringErrorException(
