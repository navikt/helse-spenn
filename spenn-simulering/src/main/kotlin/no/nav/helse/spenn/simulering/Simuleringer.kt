                    ...
                    linjer = packet["Simulering.linjer"].map { linje ->
                        SimuleringRequest.Oppdrag.Oppdragslinje(
                            ...
                            klassekode = when (val kode = linje.path("klassekode").asText()) {
                                ...
                                "SPSND-OP" -> SimuleringRequest.Oppdrag.Oppdragslinje.Klassekode.BARNEPASSER
                                "SPSNDDM-OP" -> SimuleringRequest.Oppdrag.Oppdragslinje.Klassekode.SELVSTENDIG_NÆRINGSDRIVENDE
